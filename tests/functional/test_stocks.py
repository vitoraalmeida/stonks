"""
Este arquivo (test_stocks.py) contém os testes funcionais para o blueprint stocks
"""
...
def test_index_page(test_client):
    ...
    # usando a fixture não precisamos do cliente em cada teste
    ...
    assert b'Bem vindo ao <strong>Stonks!</strong>' in response.data
